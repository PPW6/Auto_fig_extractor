...
class Dictionary:
    def __init__(self, path):
        ...
        self.legend_writing_type = eval(cp.get("DICTIONARY", 'legend_writing_type'))
        ...
        self.coreference_resolution = eval(cp.get("DICTIONARY", 'coreference_resolution'))
        self.process_parameter = eval(cp.get("DICTIONARY", 'process_parameter'))
        self.process_writing_type = eval(cp.get("DICTIONARY", 'process_writing_type'))
